 ...
 * problema simboličke regresije uz korištenje automatski
 * definiranih funkcija. Pri simboličkoj regresiji se
 * nastoji pronaći analitički oblik nepoznate funkcije
 ...
 * @author Marko Pielić
 */
public class SymbolicRegressionADF implements IEvaluate {
	...
	public static void main(String[] args) {
		SymbolicRegressionADF symb = new SymbolicRegressionADF();
		symb.pokreni(args);
