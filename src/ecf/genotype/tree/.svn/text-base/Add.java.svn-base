...
/**
 * Primitiv koji predstavlja operaciju zbrajanja.
 * 
 * @author Marko Pielić
 * @param <T> Tip podatka nad kojim se računa zbrajanje, mora biti broj
 */
public class Add<T extends Number> extends Primitive<T> {
