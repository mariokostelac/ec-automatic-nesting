...
/**
 * Primitiv koji predstavlja operaciju množenja.
 * 
 * @author Marko Pielić
 * @param <T> Tip podatka nad kojim se računa množenje, mora biti broj
 */
public class Mul<T extends Number> extends Primitive<T> {
