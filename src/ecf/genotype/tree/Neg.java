...
/**
 * Primitiv koji predstavlja operaciju neg.
 * pos(x) = x<0 ? x : 0
 * 
 * @author Marko Pielić
 * @param <T> Tip podatka nad kojim se računa neg, mora biti broj
 */
public class Neg<T extends Number> extends Primitive<T> {
